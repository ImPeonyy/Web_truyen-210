    ...
    <div class="app">
        <header class="header">
            <nav class="header__navbar">
                ...
                <div class="header__navbar-dropmenu" style="right: 3%;">
            ...
            <div class="container__webbody">
                <div class="container__webbody-box ">
                        <?php
                            ...
                            $sql = "SELECT * FROM truyen ORDER BY 'truyen_id' ASC LIMIT ".$item_per_page." OFFSET ".$offset;
                ...
                <div class="container__webbody-pagination">
                    <?php 
                        if($current_page > 1){
                            $prev = $current_page - 1;    
                            echo "<a class='pagelink' href='?page=".$prev."'><h2> Prev </h2></a>";
                        }

                        if($current_page > 3){
                            $first_page = 1;   
                            echo "<a class='pagelink' href='?page=".$first_page."'><h2> First </h2></a>"; 
                        }

                        for ($i = 1; $i <= $total_page; $i++) { 
                            if($i != $current_page) {
                                if($i > $current_page - 3 && $i <$current_page + 3) {
                                    echo "<a class='pagelink' href='?page=".$i."'><h2> $i </h2></a>";
                                }
                            } else {
                            echo "<strong class='pagelink' href='?page=".$i."'><h2> $i </h2></strong>";
                                    } 
                                }

                        if($current_page < $total_page - 3){
                            $last_page = $total_page;
                            echo "<a class='pagelink' href='?page=".$last_page."'><h2> Last </h2></a>";
                        }

                        if($current_page <$total_page){
                            $next = $current_page + 1;    
                            echo "<a class='pagelink' href='?page=".$next."'><h2> Next </h2></a>";
                        }
                    ?>
                </div>
